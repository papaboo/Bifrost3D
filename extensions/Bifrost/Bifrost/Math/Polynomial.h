// Bifrost polynomial fitting utilities.
// ----------------------------------------------------------------------------
...
#ifndef _BIFROST_MATH_POLYNOMIAL_H_
#define _BIFROST_MATH_POLYNOMIAL_H_
...
template<class T>
inline std::ostream& operator<<(std::ostream& s, Bifrost::Math::Polynomial v) {
    return s << v.to_string();
}

#endif // _BIFROST_MATH_POLYNOMIAL_H_
