...
inline Dx11Material make_dx11material(Material mat) {
    ...
    dx11_material.textures_bound = mat.get_tint_texture_ID() ? TextureBound::Tint | TextureBound::Roughness : TextureBound::None;
...
inline Dx11MaterialTextures make_dx11material_textures(Material mat) {
    ...
    dx11_material_textures.tint_roughness_index = mat.get_tint_texture_ID();
