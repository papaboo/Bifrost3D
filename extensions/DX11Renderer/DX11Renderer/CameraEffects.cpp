...
// Gaussian Bloom.
// ------------------------------------------------------------------------------------------------
GaussianBloom::GaussianBloom(ID3D11Device1& device, const ShaderManager& shader_manager) {
    ...
    OBlob horizontal_filter_blob = shader_manager.compile_shader_from_file(shader_filename, "cs_5_0", "CameraEffects::sampled_gaussian_horizontal_filter");
    THROW_DX11_ERROR(device.CreateComputeShader(UNPACK_BLOB_ARGS(horizontal_filter_blob), nullptr, &m_horizontal_filter));

    OBlob vertical_filter_blob = shader_manager.compile_shader_from_file(shader_filename, "cs_5_0", "CameraEffects::sampled_gaussian_vertical_filter");
...
// Dual Kawase Bloom.
// ------------------------------------------------------------------------------------------------
DualKawaseBloom::DualKawaseBloom(ID3D11Device1& device, const ShaderManager& shader_manager) {

    m_temp = {};

    auto shader_filename = "CameraEffects/Bloom.hlsl";

    OBlob m_extract_high_intensity_blob = shader_manager.compile_shader_from_file(shader_filename, "cs_5_0", "CameraEffects::extract_high_intensity");
    ...
    OBlob downsample_pattern_blob = shader_manager.compile_shader_from_file(shader_filename, "cs_5_0", "CameraEffects::dual_kawase_downsample");
    THROW_DX11_ERROR(device.CreateComputeShader(UNPACK_BLOB_ARGS(downsample_pattern_blob), nullptr, &m_downsample_pattern));

    OBlob upsample_pattern_blob = shader_manager.compile_shader_from_file(shader_filename, "cs_5_0", "CameraEffects::dual_kawase_upsample");
...
// ------------------------------------------------------------------------------------------------
LogAverageLuminance::LogAverageLuminance(ID3D11Device1& device, const ShaderManager& shader_manager) {
    auto shader_filename = "CameraEffects/ReduceLogAverageLuminance.hlsl";

    // Create shaders.
    OBlob log_average_first_reduction_blob = shader_manager.compile_shader_from_file(shader_filename, "cs_5_0", "CameraEffects::first_reduction");
    ...
    OBlob log_average_computation_blob = shader_manager.compile_shader_from_file(shader_filename, "cs_5_0", "CameraEffects::compute_log_average");
    ...
    OBlob linear_exposure_computation_blob = shader_manager.compile_shader_from_file(shader_filename, "cs_5_0", "CameraEffects::compute_linear_exposure");
...
// Exposure histogram
// ------------------------------------------------------------------------------------------------
ExposureHistogram::ExposureHistogram(ID3D11Device1& device, const ShaderManager& shader_manager) {
    auto shader_filename = "CameraEffects/ReduceExposureHistogram.hlsl";

    // Create shaders.
    OBlob reduce_exposure_histogram_blob = shader_manager.compile_shader_from_file(shader_filename, "cs_5_0", "CameraEffects::reduce");
...
// ------------------------------------------------------------------------------------------------
CameraEffects::CameraEffects(ID3D11Device1& device, const ShaderManager& shader_manager) {
    ...
    m_log_average_luminance = LogAverageLuminance(device, shader_manager);
    m_exposure_histogram = ExposureHistogram(device, shader_manager);

    m_bloom = GaussianBloom(device, shader_manager);
    ...
    { // Setup tonemapping shaders
        ...
        OBlob linear_exposure_from_bias_blob = shader_manager.compile_shader_from_file(shader_filename, "cs_5_0", "CameraEffects::linear_exposure_from_constant_bias");
        ...
        OBlob vertex_shader_blob = shader_manager.compile_shader_from_file(shader_filename, "vs_5_0", "CameraEffects::fullscreen_vs");
        ...
        auto create_pixel_shader = [&](const char* entry_point) -> OPixelShader {
            ...
            OBlob pixel_shader_blob = shader_manager.compile_shader_from_file(shader_filename, "ps_5_0", entry_point);
