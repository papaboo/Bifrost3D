...
// #endif
    ...
    Implementation(CUcontext cuda_context, const std::filesystem::path& data_directory, RendererID renderer_ID)
        ...
        int cuda_device_id;
        THROW_CUDA_ERROR(cudaGetDevice(&cuda_device_id));
        cudaDeviceProp device_properties;
        THROW_CUDA_ERROR(cudaGetDeviceProperties(&device_properties, cuda_device_id));
...
#define OPTIX_CHECK(error) check_error_with_log(error, __FILE__,__LINE__)
        ...
        { // Setup module
            ...
            OPTIX_CHECK(optixModuleCreate(m_context,&module_compile_options, &pipeline_compile_options,
