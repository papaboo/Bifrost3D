...
if (WIN32)
  ...
  set(ANT_TWEAK_BAR_ROOT "${COGWHEEL_LIBS_DIR}/AntTweakBar")
  ...
  if (NOT EXISTS ${ANT_TWEAK_BAR_ROOT}/include/AntTweakBar.h)
    ...
    set(ANT_TWEAK_BAR_LIBS_DIR "${COGWHEEL_LIBS_DIR}/AntTweakBar")
    ...
    if(NOT status_code EQUAL 0)
      ...
      execute_process(COMMAND ${CMAKE_COMMAND} -E tar xzf "${ANT_TWEAK_BAR_ZIP_DEST}" WORKING_DIRECTORY "${COGWHEEL_LIBS_DIR}")
...
FIND_PACKAGE_HANDLE_STANDARD_ARGS(ANT_TWEAK_BAR DEFAULT_MSG ANT_TWEAK_BAR_LIBRARIES ANT_TWEAK_BAR_INCLUDE_DIRS)
