...
GTEST_TEST(DefaultShadingModel, regression_test) {
    ...
    BSDFResponse bsdf_responses[] = {
        ...
        { 994713.875f, 762452.5f, 335647.5f, 703369.687500f }, { 249079.843750f, 190921.390625f, 84049.03906f, 175985.171875f },
        { 4956792320.0f, 4899898880.0f, 4795352064.0f, 49659876.0f }, { 1455492480.0f, 1439430400.0f, 1409914496.0f, 13439784.0f },
        // Plastic
        { 0.012626f, 0.090606f, 0.10932f, 0.005306f }, { 0.012312f, 0.090292f, 0.10901f, 0.222997f },
        { 0.011338f, 0.089015f, 0.10766f, 0.004113f }, { 0.021728f, 0.099405f, 0.11805f, 0.245806f },
        { 0.054515f, 0.125152f, 0.14210f, 0.352419f }, { 0.099098f, 0.169734f, 0.18669f, 0.376433f },
        // Coated plastic
        { 0.025724f, 0.100578f, 0.11854f, 0.012162f }, { 0.024169f, 0.099023f, 0.11699f, 0.219775f },
        { 0.022803f, 0.097154f, 0.11500f, 0.009341f }, { 0.043613f, 0.117963f, 0.13581f, 0.259220f },
        { 0.090491f, 0.154181f, 0.16947f, 0.354149f }, { 0.155201f, 0.218890f, 0.23418f, 0.383586f }, };
