// Test Cogwheel math type traits.
// ---------------------------------------------------------------------------
...
#ifndef _COGWHEEL_MATH_TYPE_TRAITS_TEST_H_
#define _COGWHEEL_MATH_TYPE_TRAITS_TEST_H_
...
#endif // _COGWHEEL_MATH_TYPE_TRAITS_TEST_H_