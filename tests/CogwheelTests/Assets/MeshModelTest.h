...
TEST_F(Assets_MeshModels, sentinel_mesh) {
    ...
    EXPECT_EQ(MeshModels::get_model(sentinel_ID).scene_node_ID, Scene::SceneNodes::UID::invalid_UID());
    EXPECT_EQ(MeshModels::get_scene_node_ID(sentinel_ID), Scene::SceneNodes::UID::invalid_UID());
    EXPECT_EQ(MeshModels::get_model(sentinel_ID).mesh_ID, Meshes::UID::invalid_UID());
...
TEST_F(Assets_MeshModels, create) {
    ...
    EXPECT_EQ(MeshModels::get_model(model_ID).scene_node_ID, node_ID);
    EXPECT_EQ(MeshModels::get_scene_node_ID(model_ID), node_ID);
    EXPECT_EQ(MeshModels::get_model(model_ID).mesh_ID, mesh_ID);
    EXPECT_EQ(MeshModels::get_mesh_ID(model_ID), mesh_ID);
    EXPECT_EQ(MeshModels::get_model(model_ID).material_ID, material_ID);
