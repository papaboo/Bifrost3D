...
TEST_F(ExposureHistogramFixture, tiny_image) {
    ...
    ExposureHistogram& histogram = ExposureHistogram(*device, ShaderManager());
...
TEST_F(ExposureHistogramFixture, exposure_from_constant_histogram) {
    ...
    OBlob compute_exposure_blob = ShaderManager().compile_shader_from_file("CameraEffects/ReduceExposureHistogram.hlsl", "cs_5_0", "CameraEffects::compute_linear_exposure");
